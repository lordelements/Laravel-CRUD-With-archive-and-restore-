          ...
          <div class="row">
            <div class="col-8">
              ...
              <h5 class="font-weight-bolder mb-0">
                {{ $users->count() }}
                <a href="{{ route('registered_users') }}" class="text-success text-sm font-weight-bolder">users</a>
              </h5>
        ...
        <div class="card-body p-3 position-relative">
          <div class="row">
            <div class="col-8">
              ...
              <h5 class="font-weight-bolder mb-0">
                {{ $posts->count() }}
                <a href="{{ route('posts.index') }}" class="text-success text-sm font-weight-bolder">posts</a>
              </h5>
