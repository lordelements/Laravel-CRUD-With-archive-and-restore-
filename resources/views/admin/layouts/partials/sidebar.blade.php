    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link  " href="{{ route('posts.index') }}">
                ...
                <span class="nav-link-text ms-1">Uploaded posts</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link  " href="{{ route('admin.create_posts') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1">Create Posts</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link  " href="{{ url('registered_users') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1"><i class="bi bi-people"></i>Users</span>
            </a>
        </li>
        ...
        <!-- <li class="nav-item">
            <a class="nav-link" href="{{route('profile.edit')}}">
                ...
                <span class="nav-link-text ms-1"> {{ __('Profile 1') }}</span>
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link  " href="../pages/sign-up.html">
                ...
                <span class="nav-link-text ms-1">Add footer links</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link  " href="../pages/sign-up.html">
                ...
                <span class="nav-link-text ms-1">Add Contact information</span>
            </a>
        </li>
    </ul>
</div>