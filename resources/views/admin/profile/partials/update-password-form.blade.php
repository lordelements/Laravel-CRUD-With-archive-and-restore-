<form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
    ...
    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">New Password</strong>
        <div class="form-group">
    ...
    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Confirm Password</strong>
        <div class="form-group">
